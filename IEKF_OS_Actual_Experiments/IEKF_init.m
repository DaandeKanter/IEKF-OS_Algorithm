...
function [IEKF, vSensor] = IEKF_init(q_init, u_init, tau_init, Covariances)
    ...
    CovarianceGyro1 = Covariances.Noise_Cov_Gyro_1 * 150;
    CovarianceAcc1  = Covariances.Noise_Cov_Acc_1  * 150;
    CovarianceGyro2 = Covariances.Noise_Cov_Gyro_2 * 150;
    CovarianceAcc2  = Covariances.Noise_Cov_Acc_2  * 150;
    CovarianceGyro3 = Covariances.Noise_Cov_Gyro_3 * 150;
    CovarianceAcc3  = Covariances.Noise_Cov_Acc_3  * 150;
    CovarianceGyro4 = Covariances.Noise_Cov_Gyro_4 * 150;
    CovarianceAcc4  = Covariances.Noise_Cov_Acc_4  * 150;
    CovarianceGyro5 = Covariances.Noise_Cov_Gyro_5 * 150;
    CovarianceAcc5  = Covariances.Noise_Cov_Acc_5  * 150;
    CovarianceGyro6 = Covariances.Noise_Cov_Gyro_6 * 150;
    CovarianceAcc6  = Covariances.Noise_Cov_Acc_6  * 150;
