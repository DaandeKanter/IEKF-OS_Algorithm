function [IEKF, vSensor] = IEKF_update_step(IEKF, vSensor, Xsens, IMU1, IMU2, IMU3, IMU4, IMU5, IMU6, osimModel, state, t, torque1Gen, torque2Gen, torque3Gen, torque4Gen, torque5Gen, torque6Gen, ground, GravityVec, str2)
...
%     end
    ...
    yNoise_AngVel_1_localX = [Xsens.IMU1_AngVel(1,t+1);
                              Xsens.IMU1_AngVel(2,t+1);
                              Xsens.IMU1_AngVel(3,t+1)];
                          
    yNoise_LinAcc_1_localX = [Xsens.IMU1_LinAcc(1,t+1);
                              Xsens.IMU1_LinAcc(2,t+1);
                              Xsens.IMU1_LinAcc(3,t+1)];
                                
    % Measurement Xsens IMU 2 angular velocity and linear acceleration
    yNoise_AngVel_2_localX = [Xsens.IMU2_AngVel(1,t+1);
                              Xsens.IMU2_AngVel(2,t+1);
                              Xsens.IMU2_AngVel(3,t+1)];
                          
    yNoise_LinAcc_2_localX = [Xsens.IMU2_LinAcc(1,t+1);
                              Xsens.IMU2_LinAcc(2,t+1);
                              Xsens.IMU2_LinAcc(3,t+1)];
                          
    % Measurement Xsens IMU 3 angular velocity and linear acceleration
    yNoise_AngVel_3_localX = [Xsens.IMU3_AngVel(1,t+1);
                              Xsens.IMU3_AngVel(2,t+1);
                              Xsens.IMU3_AngVel(3,t+1)];
                          
    yNoise_LinAcc_3_localX = [Xsens.IMU3_LinAcc(1,t+1);
                              Xsens.IMU3_LinAcc(2,t+1);
                              Xsens.IMU3_LinAcc(3,t+1)];
                          
    % Measurement Xsens IMU 4 angular velocity and linear acceleration
    yNoise_AngVel_4_localX = [Xsens.IMU4_AngVel(1,t+1);
                              Xsens.IMU4_AngVel(2,t+1);
                              Xsens.IMU4_AngVel(3,t+1)];
                          
    yNoise_LinAcc_4_localX = [Xsens.IMU4_LinAcc(1,t+1);
                              Xsens.IMU4_LinAcc(2,t+1);
                              Xsens.IMU4_LinAcc(3,t+1)];
    
    % Measurement Xsens IMU 5 angular velocity and linear acceleration
    yNoise_AngVel_5_localX = [Xsens.IMU5_AngVel(1,t+1);
                              Xsens.IMU5_AngVel(2,t+1);
                              Xsens.IMU5_AngVel(3,t+1)];
                          
    yNoise_LinAcc_5_localX = [Xsens.IMU5_LinAcc(1,t+1);
                              Xsens.IMU5_LinAcc(2,t+1);
                              Xsens.IMU5_LinAcc(3,t+1)];
                          
    % Measurement Xsens IMU 6 angular velocity and linear acceleration
    yNoise_AngVel_6_localX = [Xsens.IMU6_AngVel(1,t+1);
                              Xsens.IMU6_AngVel(2,t+1);
                              Xsens.IMU6_AngVel(3,t+1)];
                          
    yNoise_LinAcc_6_localX = [Xsens.IMU6_LinAcc(1,t+1);
                              Xsens.IMU6_LinAcc(2,t+1);
                              Xsens.IMU6_LinAcc(3,t+1)]; 
