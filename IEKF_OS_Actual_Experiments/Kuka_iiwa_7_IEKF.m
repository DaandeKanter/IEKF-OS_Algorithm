...
fprintf('\n');
prompt1 = 'Do you want to visualize the simulation? [y]es/[n]o: ';
...
%% Do you want to write the IEKF outputs to the command window? Used for checking/debugging.
fprintf('\n');
prompt2 = 'Do you want to write the IEKF outputs to the command window? [y]es/[n]o: ';
...
mainFolder = '/Users/daandekanter/Stack/Documenten/Thesis/MethodsGithub/KUKAIntermediateFramesActualExperiment';
folderWithTrials          = 'Daan_de_Kanter_KUKA_Experiment1_4_12_2020/Experiment';
folderWithStationaryData  = 'Daan_de_Kanter_KUKA_Experiment1_4_12_2020/Stationary';
folderWithRotationaryData = 'Daan_de_Kanter_KUKA_Experiment1_4_12_2020/Rotationary';
cd(folderWithTrials);

% Create a struct to store all the raw data:
XsensRaw = struct;
fprintf('\n');
n = input('Enter the number of the desired trial: ');
switch n
    case 1
        % --------------------Trial 1. Date: 04-12-2020--------------------        
        % Load the corresponding Experimental Xsens IMU data.
        cd Motion_1
        XsensRaw.IMU1 = textscan(fopen('Trial1_00B44109.txt'), '%n %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f', 'Delimiter', ',', 'HeaderLines', 13);
        XsensRaw.IMU2 = textscan(fopen('Trial1_00B44112.txt'), '%n %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f', 'Delimiter', ',', 'HeaderLines', 13);
        XsensRaw.IMU3 = textscan(fopen('Trial1_00B44113.txt'), '%n %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f', 'Delimiter', ',', 'HeaderLines', 13);
        XsensRaw.IMU4 = textscan(fopen('Trial1_00B44058.txt'), '%n %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f', 'Delimiter', ',', 'HeaderLines', 13);
        XsensRaw.IMU5 = textscan(fopen('Trial1_00B43FA9.txt'), '%n %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f', 'Delimiter', ',', 'HeaderLines', 13);
        XsensRaw.IMU6 = textscan(fopen('Trial1_00B43F80.txt'), '%n %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f', 'Delimiter', ',', 'HeaderLines', 13);
        cd(mainFolder)
        
        % Load the data from the KUKA encoders.
        Trial = load('IMU_trial1_005_12.txt'); % Frequency of 0.05 Hz. Amplitude of 1.2 rad.
        
    case 2
        % --------------------Trial 2. Date: 04-12-2020--------------------     
        % Load the corresponding Experimental Xsens IMU data.
        cd Motion_2
        XsensRaw.IMU1 = textscan(fopen('Trial2_00B44109.txt'), '%n %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f', 'Delimiter', ',', 'HeaderLines', 13);
        XsensRaw.IMU2 = textscan(fopen('Trial2_00B44112.txt'), '%n %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f', 'Delimiter', ',', 'HeaderLines', 13);
        XsensRaw.IMU3 = textscan(fopen('Trial2_00B44113.txt'), '%n %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f', 'Delimiter', ',', 'HeaderLines', 13);
        XsensRaw.IMU4 = textscan(fopen('Trial2_00B44058.txt'), '%n %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f', 'Delimiter', ',', 'HeaderLines', 13);
        XsensRaw.IMU5 = textscan(fopen('Trial2_00B43FA9.txt'), '%n %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f', 'Delimiter', ',', 'HeaderLines', 13);
        XsensRaw.IMU6 = textscan(fopen('Trial2_00B43F80.txt'), '%n %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f', 'Delimiter', ',', 'HeaderLines', 13);
        cd(mainFolder)
        
        % Load the data from the KUKA encoders.
        Trial = load('IMU_trial2_0025_12.txt'); % Frequency of 0.025 Hz. Amplitude of 1.2 rad.
           
    case 3
        % --------------------Trial 3. Date: 04-12-2020--------------------
        % Load the corresponding Experimental Xsens IMU data.
        cd Motion_3
        XsensRaw.IMU1 = textscan(fopen('Trial3_00B44109.txt'), '%n %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f', 'Delimiter', ',', 'HeaderLines', 13);
        XsensRaw.IMU2 = textscan(fopen('Trial3_00B44112.txt'), '%n %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f', 'Delimiter', ',', 'HeaderLines', 13);
        XsensRaw.IMU3 = textscan(fopen('Trial3_00B44113.txt'), '%n %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f', 'Delimiter', ',', 'HeaderLines', 13);
        XsensRaw.IMU4 = textscan(fopen('Trial3_00B44058.txt'), '%n %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f', 'Delimiter', ',', 'HeaderLines', 13);
        XsensRaw.IMU5 = textscan(fopen('Trial3_00B43FA9.txt'), '%n %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f', 'Delimiter', ',', 'HeaderLines', 13);
        XsensRaw.IMU6 = textscan(fopen('Trial3_00B43F80.txt'), '%n %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f', 'Delimiter', ',', 'HeaderLines', 13);
        cd(mainFolder)
        
        % Load the data from the KUKA encoders.
        Trial = load('IMU_trial3_010_07.txt'); % Frequency of 0.1 Hz. Amplitude of 0.7 rad.
        
    case 4
        % --------------------Trial 4. Date: 04-12-2020--------------------       
        % Load the corresponding Experimental Xsens IMU data
        cd Motion_4
        XsensRaw.IMU1 = textscan(fopen('Trial4_00B44109.txt'), '%n %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f', 'Delimiter', ',', 'HeaderLines', 13);
        XsensRaw.IMU2 = textscan(fopen('Trial4_00B44112.txt'), '%n %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f', 'Delimiter', ',', 'HeaderLines', 13);
        XsensRaw.IMU3 = textscan(fopen('Trial4_00B44113.txt'), '%n %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f', 'Delimiter', ',', 'HeaderLines', 13);
        XsensRaw.IMU4 = textscan(fopen('Trial4_00B44058.txt'), '%n %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f', 'Delimiter', ',', 'HeaderLines', 13);
        XsensRaw.IMU5 = textscan(fopen('Trial4_00B43FA9.txt'), '%n %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f', 'Delimiter', ',', 'HeaderLines', 13);
        XsensRaw.IMU6 = textscan(fopen('Trial4_00B43F80.txt'), '%n %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f', 'Delimiter', ',', 'HeaderLines', 13);
        cd(mainFolder)
        
        % Load the data from the KUKA encoders.
        Trial = load('IMU_trial4_020_07.txt'); % Frequency of 0.2 Hz. Amplitude of 0.7 rad.
end

%% Load the encoder values
% The function LoadEncoderValues(Trial) returns
%   * The encoder values of the joint angles q and joint torques tau.
%   * The initial state of the actual KUKA robot.
[Encoders, q_init] = LoadEncoderValues(Trial);

%% Load Xsens stationary and rotary data
SampleFreq = 100; % Hz

% Load the stationary data for the calibration procedure:
cd(folderWithStationaryData)
XsensRaw.StationaryDataIMU1 = textscan(fopen('StationaryData_00B44109.txt'), '%n %f %f %f %f %f %f', 'Delimiter', ',', 'HeaderLines', 13);
XsensRaw.StationaryDataIMU2 = textscan(fopen('StationaryData_00B44112.txt'), '%n %f %f %f %f %f %f', 'Delimiter', ',', 'HeaderLines', 13);
XsensRaw.StationaryDataIMU3 = textscan(fopen('StationaryData_00B44113.txt'), '%n %f %f %f %f %f %f', 'Delimiter', ',', 'HeaderLines', 13);
XsensRaw.StationaryDataIMU4 = textscan(fopen('StationaryData_00B44058.txt'), '%n %f %f %f %f %f %f', 'Delimiter', ',', 'HeaderLines', 13);
XsensRaw.StationaryDataIMU5 = textscan(fopen('StationaryData_00B43FA9.txt'), '%n %f %f %f %f %f %f', 'Delimiter', ',', 'HeaderLines', 13);
XsensRaw.StationaryDataIMU6 = textscan(fopen('StationaryData_00B43F80.txt'), '%n %f %f %f %f %f %f', 'Delimiter', ',', 'HeaderLines', 13);
cd(mainFolder)

% Load the rotary data for the calibration procedure:
cd(folderWithRotationaryData)
cd('Xsens1')
XsensRaw.RotaryDataIMU1 = textscan(fopen('RotationaryData1.txt'), '%n %f %f %f %f %f %f', 'Delimiter', ',', 'HeaderLines', 13);
cd(mainFolder)

cd(folderWithRotationaryData)
cd('Xsens2')
XsensRaw.RotaryDataIMU2 = textscan(fopen('RotationaryData2.txt'), '%n %f %f %f %f %f %f', 'Delimiter', ',', 'HeaderLines', 13);
cd(mainFolder)

cd(folderWithRotationaryData)
cd('Xsens3')
XsensRaw.RotaryDataIMU3 = textscan(fopen('RotationaryData3.txt'), '%n %f %f %f %f %f %f', 'Delimiter', ',', 'HeaderLines', 13);
cd(mainFolder)

cd(folderWithRotationaryData)
cd('Xsens4')
XsensRaw.RotaryDataIMU4 = textscan(fopen('RotationaryData4.txt'), '%n %f %f %f %f %f %f', 'Delimiter', ',', 'HeaderLines', 13);
cd(mainFolder)

cd(folderWithRotationaryData)
cd('Xsens5')
XsensRaw.RotaryDataIMU5 = textscan(fopen('RotationaryData5.txt'), '%n %f %f %f %f %f %f', 'Delimiter', ',', 'HeaderLines', 13);
cd(mainFolder)

cd(folderWithRotationaryData)
cd('Xsens6')
XsensRaw.RotaryDataIMU6 = textscan(fopen('RotationaryData6.txt'), '%n %f %f %f %f %f %f', 'Delimiter', ',', 'HeaderLines', 13);
cd(mainFolder)


%% Calibrate Xsens IMU data using ellipsoid fitting method
% Function that returns:
%       * Xsens struct with the calibrated data.
%       * CalParam struct with the calibration parameters of the IMUs.
%       * Covariances struct with the covariance matrices of the IMUs.
%                  * For each IMU the covariance of the gyroscope.
%                  * For each IMU the covariance of the accelerometer.

[Xsens, CalParam, Covariances] = CalibrateIMUData(SampleFreq, XsensRaw);

%% Set the start of the data
%  Define the start point of the data as the recording of the Xsens
%  data started before the motion of the KUKA was initiated.
%  Check from the Xsens IMU angular velocity when the motion is initiated.
fprintf('\n');
prompt3 = 'In the next figure, specify the time instant in seconds when the angular velocity starts increasing, this is the start of the reconstruction.\nTime instant = ';

figure,
plot(Xsens.IMU6_AngVel(1,:))
hold on
plot(Xsens.IMU6_AngVel(2,:))
hold on
plot(Xsens.IMU6_AngVel(3,:))

StartTime = input(prompt3); % Looking by eye from trial 1 this should be 5.09 seconds
startEntryXsensIMUData = StartTime*SampleFreq;

fprintf('\n');
prompt4 = 'Specify the end time in seconds till which the motion should be reconstructed .\nFinal time = ';
FinalTime = input(prompt4);
finalEntryXsensIMUData = FinalTime*SampleFreq;

%% Specify the raw IMU data accordingly to these priorly desired times
% IMU 1
Xsens.IMU1_AngVel = [zeros(3,1) Xsens.IMU1_AngVel(:, startEntryXsensIMUData:finalEntryXsensIMUData);];
Xsens.IMU1_LinAcc = [zeros(3,1) Xsens.IMU1_LinAcc(:, startEntryXsensIMUData:finalEntryXsensIMUData);];

% IMU 2
Xsens.IMU2_AngVel = [zeros(3,1) Xsens.IMU2_AngVel(:, startEntryXsensIMUData:finalEntryXsensIMUData);];
Xsens.IMU2_LinAcc = [zeros(3,1) Xsens.IMU2_LinAcc(:, startEntryXsensIMUData:finalEntryXsensIMUData);];

% IMU 3
Xsens.IMU3_AngVel = [zeros(3,1) Xsens.IMU3_AngVel(:, startEntryXsensIMUData:finalEntryXsensIMUData);];
Xsens.IMU3_LinAcc = [zeros(3,1) Xsens.IMU3_LinAcc(:, startEntryXsensIMUData:finalEntryXsensIMUData);];

% IMU 4
Xsens.IMU4_AngVel = [zeros(3,1) Xsens.IMU4_AngVel(:, startEntryXsensIMUData:finalEntryXsensIMUData);];
Xsens.IMU4_LinAcc = [zeros(3,1) Xsens.IMU4_LinAcc(:, startEntryXsensIMUData:finalEntryXsensIMUData);];

% IMU 5
Xsens.IMU5_AngVel = [zeros(3,1) Xsens.IMU5_AngVel(:, startEntryXsensIMUData:finalEntryXsensIMUData);];
Xsens.IMU5_LinAcc = [zeros(3,1) Xsens.IMU5_LinAcc(:, startEntryXsensIMUData:finalEntryXsensIMUData);];

% IMU 6
Xsens.IMU6_AngVel = [zeros(3,1) Xsens.IMU6_AngVel(:, startEntryXsensIMUData:finalEntryXsensIMUData);];
Xsens.IMU6_LinAcc = [zeros(3,1) Xsens.IMU6_LinAcc(:, startEntryXsensIMUData:finalEntryXsensIMUData);];
...
dTime = 1/SampleFreq;    % Sampling time of the IMU: 1/Hz
for t = 1:(size(Xsens.IMU1_AngVel(1, :), 2)-2) % Minus 2 as the first entry "0" has already been included above and a "0" has been included in the length of IMU1_AngVel(1, :)
    Xsens.T(end+1) = t*dTime;
end

Xsens.TotalSimulationTimeValue = length(Xsens.T);

%% Determine angular velocity from joint encoder measurements
Encoders = DetermineAngularVelocityFromEncoders(Encoders, Xsens);
...
%% Set a pertubation value such that the convergence of the IEKF-OS can be checked for a different initialization
PerturbValue = deg2rad(0); % Added to the initial states to see if the IEKF-OS converges

%% Create actuators and controllers for all the joints
...
%% Load the Xsens Orientation Parameters for modeling the virtual frames in OpenSim
%  Generated using the script XsensOrientationParameters.m
load('XsensOrientationParametersForOpenSim.mat');
...
IMU1.set_translation(Vec3(Orientation.Xsens_1_Trans_X, Orientation.Xsens_1_Trans_Y, Orientation.Xsens_1_Trans_Z)); % Translate
IMU1.set_orientation(Vec3(Orientation.Xsens_1_Rot_X, Orientation.Xsens_1_Rot_Y, Orientation.Xsens_1_Rot_Z));           % Rotate
...
IMU2.set_translation(Vec3(Orientation.Xsens_2_Trans_X, Orientation.Xsens_2_Trans_Y, Orientation.Xsens_2_Trans_Z)); % Translate
IMU2.set_orientation(Vec3(Orientation.Xsens_2_Rot_X, Orientation.Xsens_2_Rot_Y, Orientation.Xsens_2_Rot_Z)); % Rotate 0.3 + -1.5708 = -1.2708
...
IMU3.set_translation(Vec3(Orientation.Xsens_3_Trans_X, Orientation.Xsens_3_Trans_Y, Orientation.Xsens_3_Trans_Z)); % Translate
IMU3.set_orientation(Vec3(Orientation.Xsens_3_Rot_X, Orientation.Xsens_3_Rot_Y, Orientation.Xsens_3_Rot_Z));   % Rotate =  -1.5708 + -0.4
...
IMU4.set_translation(Vec3(Orientation.Xsens_4_Trans_X, Orientation.Xsens_4_Trans_Y, Orientation.Xsens_4_Trans_Z)); % Translate
IMU4.set_orientation(Vec3(Orientation.Xsens_4_Rot_X, Orientation.Xsens_4_Rot_Y, Orientation.Xsens_4_Rot_Z));  % Rotate 1.5708 - 0.3 = 1.2708
...
IMU5.set_translation(Vec3(Orientation.Xsens_5_Trans_X, Orientation.Xsens_5_Trans_Y, Orientation.Xsens_5_Trans_Z)); % Translate
IMU5.set_orientation(Vec3(Orientation.Xsens_5_Rot_X, Orientation.Xsens_5_Rot_Y, Orientation.Xsens_5_Rot_Z));   % Rotate = -0.3 + -1.570796326794897
...
IMU6.set_translation(Vec3(Orientation.Xsens_6_Trans_X, Orientation.Xsens_6_Trans_Y, Orientation.Xsens_6_Trans_Z)); % Translate
IMU6.set_orientation(Vec3(Orientation.Xsens_6_Rot_X, Orientation.Xsens_6_Rot_Y, Orientation.Xsens_6_Rot_Z));   % Rotate 0.15 + -1.5708 = -1.4208 
...
%                                    * Assemble to satisfy position constraints
...
IEKF.finalTime = Xsens.T(end); %FinalTime; %round(size(Xsens.T,2)/SampleFreq)-1;
...
for t = 1:IEKF.n
    ...
    [IEKF, vSensor] = IEKF_update_step(IEKF, vSensor, Xsens, IMU1, IMU2, IMU3, IMU4, IMU5, IMU6, osimModel, state, t, torque1Gen, torque2Gen, torque3Gen, torque4Gen, torque5Gen, torque6Gen, ground, GravityVec, str2);
    end
    ...
    % Show how far the simulation is:
    waitbar(t/IEKF.n,h)
end
...
RMSE = RMSEcalculate(IEKF, Encoders, Xsens);
...
figure(1)
subplot(3,2,1)
plot(IEKF.T(1,:), Encoders.q1(1,1:length(IEKF.x_upds(1,:))), 'LineWidth', 4)        % Actual generalized coordinate q1
hold on
plot(IEKF.T(1,:),    IEKF.x_upds(1,:),'o--g','MarkerIndices',1:250:length(IEKF.x_upds(1,:)),'MarkerSize',16,...
...
set(gca, 'FontSize',24)
set(gcf,'color','w');
xlim([0 Xsens.TotalSimulationTimeValue/SampleFreq])

subplot(3,2,2)
plot(IEKF.T(1,:), Encoders.u1(1,1:length(IEKF.x_upds(7,:))), 'LineWidth', 4)        % Actual generalized coordinate u1
hold on
plot(IEKF.T(1,:),    IEKF.x_upds(7,:),'o--g','MarkerIndices',1:250:length(IEKF.x_upds(1,:)),'MarkerSize',16,...
...
subplot(3,2,3)
plot(IEKF.T(1,:), Encoders.q2(1,1:length(IEKF.x_upds(2,:))), 'LineWidth', 4)        % Actual generalized coordinate q2
hold on
plot(IEKF.T(1,:),    IEKF.x_upds(2,:),'o--g','MarkerIndices',1:250:length(IEKF.x_upds(1,:)),'MarkerSize',16,...
...
subplot(3,2,4)
plot(IEKF.T(1,:), Encoders.u2(1,1:length(IEKF.x_upds(8,:))), 'LineWidth', 4)       % Actual generalized coordinate u2
hold on
plot(IEKF.T(1,:),    IEKF.x_upds(8,:),'o--g','MarkerIndices',1:250:length(IEKF.x_upds(1,:)),'MarkerSize',16,...
...
subplot(3,2,5)
plot(IEKF.T(1,:), Encoders.q3(1,1:length(IEKF.x_upds(3,:))), 'LineWidth', 4)        % Actual generalized coordinate q3
hold on
plot(IEKF.T(1,:),    IEKF.x_upds(3,:),'o--g','MarkerIndices',1:250:length(IEKF.x_upds(1,:)),'MarkerSize',16,...
...
subplot(3,2,6)
plot(IEKF.T(1,:), Encoders.u3(1,1:length(IEKF.x_upds(9,:))), 'LineWidth', 4)        % Actual generalized coordinate u3
hold on
plot(IEKF.T(1,:),    IEKF.x_upds(9,:),'o--g','MarkerIndices',1:250:length(IEKF.x_upds(1,:)),'MarkerSize',16,...
...
figure(2)
subplot(3,2,1)
plot(IEKF.T(1,:), Encoders.q4(1,1:length(IEKF.x_upds(4,:))), 'LineWidth', 4)        % Actual generalized coordinate q4
hold on
plot(IEKF.T(1,:),    IEKF.x_upds(4,:),'o--g','MarkerIndices',1:250:length(IEKF.x_upds(1,:)),'MarkerSize',16,...
...
subplot(3,2,2)
plot(IEKF.T(1,:), Encoders.u4(1,1:length(IEKF.x_upds(10,:))), 'LineWidth', 4)         % Actual generalized coordinate u4
hold on
plot(IEKF.T(1,:),    IEKF.x_upds(10,:),'o--g','MarkerIndices',1:250:length(IEKF.x_upds(1,:)),'MarkerSize',16,...
...
subplot(3,2,3)
plot(IEKF.T(1,:), Encoders.q5(1,1:length(IEKF.x_upds(5,:))), 'LineWidth', 4)        % Actual generalized coordinate q5
hold on
plot(IEKF.T(1,:),    IEKF.x_upds(5,:),'o--g','MarkerIndices',1:250:length(IEKF.x_upds(1,:)),'MarkerSize',16,...
...
subplot(3,2,4)
plot(IEKF.T(1,:), Encoders.u5(1,1:length(IEKF.x_upds(11,:))), 'LineWidth', 4)        % Actual generalized coordinate u5
hold on
plot(IEKF.T(1,:),    IEKF.x_upds(11,:),'o--g','MarkerIndices',1:250:length(IEKF.x_upds(1,:)),'MarkerSize',16,...
...
subplot(3,2,5)
plot(IEKF.T(1,:), Encoders.q6(1,1:length(IEKF.x_upds(6,:))), 'LineWidth', 4)        % Actual generalized coordinate q6
hold on
plot(IEKF.T(1,:),    IEKF.x_upds(6,:),'o--g','MarkerIndices',1:250:length(IEKF.x_upds(1,:)),'MarkerSize',16,...
...
subplot(3,2,6)
plot(IEKF.T(1,:), Encoders.u6(1,1:length(IEKF.x_upds(12,:))), 'LineWidth', 4)        % Actual generalized coordinate u6
hold on
plot(IEKF.T(1,:),    IEKF.x_upds(12,:),'o--g','MarkerIndices',1:250:length(IEKF.x_upds(1,:)),'MarkerSize',16,...
